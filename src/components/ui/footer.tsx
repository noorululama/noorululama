...
export default function Footer() {
    ...
    return (
        <footer className="mt-16 mb-20 md:mb-18 px-4 max-w-7xl mx-auto ">
            <div className="relative bg-white dark:bg-gray-900 rounded-3xl max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-start gap-8 shadow-lg border border-gray-100 dark:border-gray-800">
                ...
                {/* Main Footer Content */}
                <div className="flex flex-col md:flex-row items-start justify-between gap-8 md:gap-12 px-2 md:px-8 flex-1 w-full">

                    {/* Brand Section */}
                    <div className="flex flex-col items-start gap-3 max-w-md">
                        <Link
                            href="/"
                            className="flex flex-row gap-3 items-center justify-start group"
                        >
                            ...
                            <span className="text-2xl font-bold text-emerald-700 dark:text-emerald-400 transition-colors group-hover:text-emerald-600">
                                Noorul Ulama
                            </span>
                        </Link>
                        ...
                        <div className="flex flex-col gap-2 mt-2">
                            ...
                            >
                                ...
                                <span>jamianooriya@gmail.com</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span>+91 98470 70200</span>
                            </a>
                            <div className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                                <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" />
                                <span>Faizabad, Pattikkad PO<br />Malappuram, Kerala 679325</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
                        ...
                        <div className="flex flex-col gap-3">
                            <h4 className="uppercase font-semibold text-sm text-gray-800 dark:text-gray-200 tracking-wide">
                                Quick Links
                            </h4>
                            <div className="flex flex-col gap-2 text-sm">
                                <Link
                                    className="text-gray-600 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors font-medium"
                                    href="/"
                                >
                                    Home
                                </Link>
            ...
            {/* Bottom Bar */}
            <div className="mt-6 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="flex gap-3 items-center">
                    <a
                        ...
                        className="text-gray-600 dark:text-gray-400 hover:text-blue-600 hover:scale-110 transition-all duration-200"
                    >
                        <Facebook className="w-5 h-5" />
                    </a>
                    <a
                        href="https://www.instagram.com/noorululama"
                        target="_blank"
                        rel="nofollow noopener noreferrer"
                        aria-label="Follow us on Instagram"
                        className="text-gray-600 dark:text-gray-400 hover:text-pink-600 hover:scale-110 transition-all duration-200"
                    >
                        <Instagram className="w-5 h-5" />
                    </a>
                    <a
                        href="https://www.youtube.com/noorululama"
                        target="_blank"
                        rel="nofollow noopener noreferrer"
                        aria-label="Subscribe to our YouTube channel"
                        className="text-gray-600 dark:text-gray-400 hover:text-red-600 hover:scale-110 transition-all duration-200"
                    >
                        <Youtube className="w-5 h-5" />
                    </a>
                    <a
                        href="https://wa.me/919847070200"
                        target="_blank"
                        rel="nofollow noopener noreferrer"
                        aria-label="Chat on WhatsApp"
                        className="text-gray-600 dark:text-gray-400 hover:text-green-600 hover:scale-110 transition-all duration-200"
                    >
